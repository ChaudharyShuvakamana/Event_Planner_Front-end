...
<div className="login-box">
  ...
  <div class="container-login100">
            <h2 className="login-box-msg">Vendor Login</h2>
    <form onSubmit = {this.submitForm} class="login100-form validate-form flex-sb flex-w">     
          <div className="form-group has-feedback">
                    ...
                    <div class="row">
                    <div class="col-xs-8">
                                        <p><a id="register" href="Register">Create Account</a></p>
                                    </div >
        {/* <div class="col-xs-4">
        ...
        <div class="col-xs-4">
        <button id="login" type="submit" className="btn btn-primary btn-block btn-flat" >Login</button>
