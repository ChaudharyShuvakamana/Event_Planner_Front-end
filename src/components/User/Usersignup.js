...
export default class Usersignup extends React.Component {
    ...
    emailHandler(e) {
        ...
        if (email != "") {
            ...
            fetch("http://localhost:3000/api/user/checkemail", {
                method: "post",
                body: JSON.stringify(data),
                headers: {
                    "Content-Type": "application/json"
                            ...
                            <div className="row form-group has-feedback">
                                <Col>
                                    <FormGroup>
                                        ...
                                        <input className="form-control" type="text" id="firstname" ref="firstname" placeholder="First Name" required />
                            ...
                            <div className="row form-group has-feedback">
                                <Col>
                                    <FormGroup>
                                        ...
                                        <input className="form-control" type="text" id="lastname" ref="lastname" placeholder="Last Name" required />
                            ...
                            <div className="row form-group has-feedback">
                                <Col>
                                    <FormGroup>
                                        ...
                                        <input className="form-control" type="number" id="phonenumber" ref="phonenumber" placeholder="Enter phonenumberNumber" required />

                                        <span class="glyphicon glyphicon-phonenumber form-control-feedback"></span>
                                    </FormGroup>
                                </Col>
                            </div>
                            <div className="row form-group has-feedback">
