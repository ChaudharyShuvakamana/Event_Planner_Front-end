      ...
      handleSignup(e){
          ...
          emailHandler(e){
                  ...
                  if(email != ""){
                      ...
                      fetch("http://localhost:3000/api/vendor/checkemail", {
                          method : "post",
                          body : JSON.stringify(data),
                          headers : {
                              "Content-Type" : "application/json"
                                    ...
                                    <div className="row form-group has-feedback">
                                        <Col>
                                            <FormGroup>
                                                ...
                                                <input className="form-control" type="phonenumber" id="phonenumber" ref="phonenumber" placeholder="Enter PhoneNumber" required />
