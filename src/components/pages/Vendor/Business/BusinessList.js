...
export default class BusinessList extends React.Component{
    ...
    componentDidMount(){
        ...
        axios.get("http://localhost:3000/api/getBusinessByVendor", config).then((business) => {
            this.setState({
        ...
        if(businessarray != null){
            ...
            <div className = "col-md-4 mt-3" key = {index}>
                        <Link to = {"showbusiness/" + value._id}>    <div className = "venues">
                           ...
                           <img src = {"http://localhost:3000/public/images/" + value.businessImage } width="100px" height="60px" className = "venues-img" />
